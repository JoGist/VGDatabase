Feature: Aggiunge una review ad un gioco della libreria
Scenario: AddReview
    ...
    Then I should be on the VGDatabase_show
    When I follow "Add a review"
    Then I should be on the VGDatabase_review
    When I fill in "review[comment]" with "Review_cucumber"
    And I select "5 ★★★★★" from "Score"
    And I press "Save changes"
    Then I should be on the VGDatabase_show
    And I should see "Edit review"
